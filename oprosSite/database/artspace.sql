...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 21 2026 г., 10:33
...
CREATE TABLE `requests` (
  ...
  `payment` enum('cash','transfer') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'cash',
  `status` enum('sent','confirm','complete') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'sent'
